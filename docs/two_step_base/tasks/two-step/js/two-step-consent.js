...
* Lynde Folsom
*
* plugin for running the consent form by muderizing the two step instructions 
**/

jsPsych.plugins["two-step-consent"] = (function() {

  var plugin = {};

  plugin.info = {
    name: 'two-step-consent',
    description: 'getting consent using Poldrack Lab form',
    parameters: {
      pages: {
