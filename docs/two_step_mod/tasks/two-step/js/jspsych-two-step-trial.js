  ...
  plugin.trial = function(display_element, trial) {
    ...
    var after_first_response = function(info) {
      ...
      if ( trial.animation ) {
        ...
        setTimeout(function() { collect_ratings1(); }, 800);
    ...
    //Vars for collecting the certainty and likelihood -lmf

    var collect_ratings1 = function() {
      var plugin_id_name = "lmfplugin-html-slider-response1.js";
      ...
      html += `<div class="jspsych-survey-multi-choice-preamble">How likely is it that the selected rocket brings you to the planet you want?</div>`
    ...
    var collect_alien_ratings1 = function() {
    ...
    var after_second_response = function(info) {
      ...
      collect_alien_ratings1()
      //collect_alien_ratings2()
